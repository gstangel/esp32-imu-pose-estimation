...
void send_imu_data(esp_gatt_if_t gatts_if, uint16_t conn_id) {
    ...
    imu_data.acceleration[0] = 0xFFFFFFFF;
    ...
    imu_data.quaternion[2] = 0xFFFFFFFF;
    imu_data.quaternion[3] = 0x3A13B042;
...
extern "C" void app_main(void) {
    ...
    imu.enable_game_rotation_vector(report_interval_us);
    imu.enable_accelerometer(report_interval_us);
    imu.enable_gyro(report_interval_us);
